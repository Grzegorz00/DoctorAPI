...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20210509101449_AddedSeeders")]
            ...
            modelBuilder.Entity("WebApplication1.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2021, 5, 9, 12, 14, 48, 797, DateTimeKind.Local).AddTicks(170),
                            FirstName = "Patient1",
                            LastName = "1"
                        },
                        new
                        {
                            IdPatient = 2,
                            Birthdate = new DateTime(2021, 5, 9, 12, 14, 48, 806, DateTimeKind.Local).AddTicks(2268),
                            FirstName = "Patient2",
                            LastName = "2"
                        });
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2021, 5, 9, 12, 14, 48, 826, DateTimeKind.Local).AddTicks(6432),
                            DueDate = new DateTime(2021, 5, 9, 12, 14, 48, 826, DateTimeKind.Local).AddTicks(7033),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2021, 5, 9, 12, 14, 48, 826, DateTimeKind.Local).AddTicks(8413),
                            DueDate = new DateTime(2021, 5, 9, 12, 14, 48, 826, DateTimeKind.Local).AddTicks(8426),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
